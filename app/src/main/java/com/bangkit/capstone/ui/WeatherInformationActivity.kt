...
class WeatherInformationActivity : AppCompatActivity() {

    val city: String = "jakarta,id"
    val api: String = "b761b4cfe64507fdd7579ab7daf29996"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_weather_information)

        val arrowBack = findViewById<ImageView>(R.id.arrow_back_weather)
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val iconImageView = findViewById<ImageView>(R.id.ivWeatherInformation)
