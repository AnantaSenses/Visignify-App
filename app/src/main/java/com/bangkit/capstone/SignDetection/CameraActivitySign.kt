package com.bangkit.capstone.SignDetection
...
import com.bangkit.capstone.SignDetection.fragment.CameraConnectionFragmentSign
import com.bangkit.capstone.SignDetection.model.OverlayViewSign
import com.bangkit.capstone.R

abstract class CameraActivitySign : AppCompatActivity(), ImageReader.OnImageAvailableListener,
    CameraConnectionFragmentSign.ConnectionListener {
    ...
    private fun setFragment() {
        val cameraConnectionFragment = CameraConnectionFragmentSign()
        ...
        fragmentManager
            .beginTransaction()
            .replace(R.id.container_sign, cameraConnectionFragment)
            .commit()
    }

    fun requestRender() {
        val overlay: OverlayViewSign = findViewById<View>(R.id.overlay) as OverlayViewSign
        overlay.postInvalidate()
    }

    fun addCallback(callback: OverlayViewSign.DrawCallback?) {
        val overlay: OverlayViewSign = findViewById<View>(R.id.overlay) as OverlayViewSign
